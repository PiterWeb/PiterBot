      ...
      return;
        ...
        switch (msg.content) {
            ...
            case prefixbc+"test":
                ...
                botijochanEmb.setAuthor(botijochanname);
                joinImages([icon, 'https://images.vexels.com/media/users/3/136176/isolated/preview/416e80b4fe03f01a1ae1f5b6e51c91a4-simbolo-de-corazon-by-vexels.png',botijochanimg2]).then((img) => {
                    // Save image as file
                    img.toFile('love.png');
                  });
